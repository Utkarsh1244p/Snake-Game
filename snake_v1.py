...
class Snake:
    ...
    def create_snake(self):
        self.timmy = t.Turtle(shape= "square")
        self.tommy = t.Turtle(shape= "square")
        self.tammy = t.Turtle(shape= "square")
        self.segments = [self.timmy, self.tommy, self.tammy]
        self.x_position = 0
        for new_segment in self.segments:
            new_segment.speed("fastest")
            new_segment.color("white")
            new_segment.up()
            new_segment.goto(self.x_position, 0)
            self.x_position -= 20
